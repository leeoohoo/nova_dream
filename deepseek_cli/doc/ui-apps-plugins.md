...
> 更完整的“目录规范 + 协议 + MCP/Prompt 暴露 + Agent 运行机制”手册见：`deepseek_cli/doc/app-dev-handbook.md`
...
模板：`deepseek_cli/ui_apps/template/basic-plugin`（复制到上述目录后即可在 UI「应用」页看到）。
...
- 模板插件：`deepseek_cli/ui_apps/template/basic-plugin/plugin.json`
- 宿主扫描/同步：`deepseek_cli/electron/ui-apps/index.js`
- 宿主 schema：`deepseek_cli/electron/ui-apps/schemas.js`
- UI 应用中心：`deepseek_cli/apps/ui/src/features/apps/AppsHubView.jsx`
- UI 运行视图：`deepseek_cli/apps/ui/src/features/apps/AppsPluginView.jsx`
